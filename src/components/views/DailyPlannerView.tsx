...
import { PersianTimePicker } from '../common/PersianDateTimePicker';
import {
  CalendarDays,
  ChevronRight,
  ChevronLeft,
            ...
            <div className="flex items-center justify-between sm:justify-start gap-2 flex-shrink-0 bg-slate-800/80 px-3 py-1.5 rounded-xl border border-slate-700">
              <div className="flex items-center gap-1.5">
                ...
                <PersianTimePicker
                  compact
                  value={newBlockStart}
                  onChange={(val) => setNewBlockStart(val)}
                />
              </div>
              <div className="flex items-center gap-1.5">
                ...
                <PersianTimePicker
                  compact
                  value={newBlockEnd}
                  onChange={(val) => setNewBlockEnd(val)}
                />
              </div>
            </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1 text-xs text-purple-300 font-mono" dir="ltr">
                        <Clock className="w-3.5 h-3.5 text-purple-400" />
                        <span className="font-bold tracking-wider">{block.startTime}</span>
                        <span className="text-slate-400 text-[11px] font-sans">تا</span>
                        <span className="font-bold tracking-wider">{block.endTime}</span>
                      </div>
                    </div>
                  </div>
