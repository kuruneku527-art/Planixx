            ...
            {activeRunningTimer ? (
              ...
              >
                ...
                <div>
                  <CustomSelect
                    value={timerCategory}
                    onChange={(val) => setTimerCategory(val as TimeCategory)}
                    options={[
                      { value: 'work', label: 'کار و حرفه' },
                      { value: 'study', label: 'مطالعه و آموزش' },
                      { value: 'personal', label: 'کارهای شخصی' },
                      { value: 'health', label: 'سلامت و ورزش' },
                      { value: 'waste', label: 'اتلاف وقت' },
                    ]}
                  />
                </div>
