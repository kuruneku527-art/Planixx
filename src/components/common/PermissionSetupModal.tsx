...
export const PermissionSetupModal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Listen for manual request to open permission modal (e.g. from Settings or Notifications)
    const handleOpenModal = () => setIsOpen(true);
    window.addEventListener('open-permission-modal', handleOpenModal);
    ...
    return () => {
      unsub();
      window.removeEventListener('open-permission-modal', handleOpenModal);
    };
  }, [checkLiveStatus]);
